...
(function(){
  ...
  const BUILD='20260918-btw-production-core-150-gs1-2d';
  ...
  async function generate(result,files,onProgress){
    ...
    for(let i=0;i<labels.length;i++){
      ...
      const modeText=route.mode==='family'?'QR / GS1 QR / GS1 DataMatrix / Code39 / UPC-A / EAN-13 / GS1-128 / PDF417 / ITF-14 原生條碼':route.mode==='second'?'5C128+1DM':route.mode==='rich'?'多物件':'CEA fallback';
