...
const barcode={text:'(1P)W25NO1GWZEIR(30P)T(31P)D(Q)4000(10D)2628(21L)G(16D)20260722(31T)6612D7800(33P)1(23L)G(24L)PS(1T)6612D7800ZZ'};
...
assert.deepStrictEqual(A.extractCodeValues('1T',barcode),['6612D7800ZZ']);
const label={fields:[
